...
NeoAbs is the MkDocs theme you pick when your documentation should look like
...
Every decision in NeoAbs serves these three commitments:
...
NeoAbs is the actively-maintained alternative. It is not a Material clone — it
...
| Capability | NeoAbs | Material for MkDocs |
|-----------|--------|---------------------|
...
NeoAbs wins on the two axes developers actually feel: **identity** and
**maintenance pace**.

## The anti-default

Every "default" docs theme pushes you toward the same indigo header, the same
sidebar, the same flat surfaces. NeoAbs inverts that assumption: the defaults
